...
ROSWorker::ROSWorker(){
    ...
    connect(serverPODOROS, SIGNAL(SIG_DisConnected()), this, SLOT(onDisconnected()));
...
{
    memset(&sharedROS->refarray, 0, sizeof(ROS_JOINTREF)*100);
    int i=0;
