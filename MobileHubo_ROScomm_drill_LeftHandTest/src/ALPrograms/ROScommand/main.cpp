...
//            Mode_TOOL = DRILL_NOTHING;
        ...
        case LEFT_HANDUP:
        {
            ...
            LHpos[2] = drill_in.leftHandup_Handz;
...
//            WBmotion->addLHOriInfo(LHori, drill_in.leftHandup_time);
            ...
            WBmotion->addLElbPosInfo(5.,drill_in.leftHandup_Handz);
        ...
        case LEFT_APPROACH:
        {
            ...
            cout << "approach (x,y,z) = (" << LHpos[0] << ", " << LHpos[1] << ", " << LHpos[2] << ")" << endl;
            WBmotion->addLHPosInfo(LHpos[0], LHpos[1], LHpos[2], drill_in.leftApproach_time);


            SetOriHand(LHori,-90.0,0.0);
            WBmotion->addLHOriInfo(LHori, drill_in.leftApproach_time);
        ...
        case LEFT_PUSH:
        {
            ...
            double z  = 0;
            double r  = 0.10;
            double x0 = drill_in.leftApproach_Handx - r * cos(th);  //0.68;
            double z0 = drill_in.leftApproach_Handz - r * sin(th);  //0.57;
...
//            WBmotion->addLHOriInfo(LHori, drill_in.leftHandup_time);
        ...
        case LEFT_RELEASE:
        {
            ...
            LHpos[2] = drill_in.leftHandBack_Handz;

            WBmotion->addLHPosInfo(LHpos[0], LHpos[1], LHpos[2], drill_in.leftHandBack_time);
...
//                    CMDprint = false;
        ...
        switch(MODE_LGripper)
        {
            ...
            case GUI_GRIPPER_OPEN_HALF:
            {
//                FILE_LOG(logSUCCESS) << "IN GRIPPER_OPENHALF";
            ...
            case GUI_GRIPPER_CLOSE_QUATER:
            {
//                FILE_LOG(logSUCCESS) << "IN GRIPPER_CLOSEQUAT";
                static int gripper_cnt = 0;
                DoneL = false;
                if(gripper_cnt > MAX_GRIPPER_CNT)
                {
...
//                if(EncoderLHAND > LIMIT_Gripper)
//                cout << "EncoderLHAND: " << EncoderLHAND << endl;
                if(EncoderLHAND > LIMIT_Gripper)
                {//grasp done
...
//        cout << "DoneR = " << DoneR << ", DoneL = " << DoneL << endl;
        if(DoneR && DoneL)
        {
...
void CalculateLIMITGripper()
{
    ...
    }else
    {
        ...
        else if(MODE_Gripper == GRIPPER_OPEN_HALF)
        {
            LIMIT_Gripper = -1300.;
        }
